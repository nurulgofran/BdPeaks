...
export const mountains: Mountain[] = [
  ...
  },
  {
    ...
    prominence: 0,
    range: "Reng Tlang Range",
    description: "Marma word meaning 'inverted mountain' (Ulta Pahar). Most southeasterly border peak of Rangamati district and last major peak of Reng Tlang range inside Bangladesh. First summited by BD Explorer on 6 Nov 2013. GPS: 902 m (2,959 ft). Nearest village: Kes Pai (Khumi).",
    images: [],
