...
export const mountains: Mountain[] = [
  ...
  },
  {
    ...
    alt_name: "Ramio Tong / Pyramid Hill",
    slug: "sippi-arsuang",
    altitude_ft: 3028,
    altitude_m: 923,
    height_source: "gps",
    ...
    prominence: 431,
    range: "Alikadam area",
    description: "Also recorded as Ramju Taung on US Army 1:250k topo map (3,016 ft / 919 m) and Russian 1:200k map (917 m). GPS measured at 896 m by trekking teams. Called Pyramid Hill for its shape. Located near Alikadam, Bandarban.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
