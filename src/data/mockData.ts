...
export const mountains: Mountain[] = [
  ...
  },
  {
    ...
    prominence: 0,
    range: "Chin Hills foothills",
    description: "Yoma is the Burmese word for mountain range. Located in the Chin Hills foothills of Bandarban.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 0,
    range: "Chittagong Hill Tracts",
    description: "Located in the Chittagong Hill Tracts of Bandarban at 2,349 ft (716 m).",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  ...
  },
  {
    ...
    prominence: 469,
    range: "Chimbuk Ridge",
    description: "Kapao Tong sits on a connected ridgeline between itself and Chimbuk's main ridge, forming the drainage divide between the headwaters of Dolong and Chaimpra Jhiri. Elevation: 2,271 ft. Prominence: 469 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
    extended: {
      original_location: "21°34'15\"N 92°30'33\"E",
      topographic_prominence: "469 ft",
      line_parent: "Tower Pahar",
      drainage: "Connected ridgeline between Kapao Tong and Chimbuk's main ridge forms the drainage divide between the headwaters of Dolong and Chaimpra Jhiri.",
    },
  },
  {
    id: "21",
  ...
  },
  {
    ...
    prominence: 0,
    range: "Tripura Border Range",
    description: "Bashkero = bamboo thicket. Thum means small hillock in local dialect.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  ...
  },
  {
    ...
    prominence: 0,
    range: "Tripura Border Range",
    description: "Likely named after a border survey pillar (boundary marker) installed on or near the summit.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  ...
  },
  {
    ...
    prominence: 0,
    range: "Reng Tlang Range",
    description: "3rd or 2nd highest peak in Bangladesh. GPS measured 1,010 m (3,314 ft) by first expedition (2011, led by Wadud Mohosin Rubel). Highest peak of Rangamati Hill District. Also known as Masha Panji Haphong. Access via Ruma Bazar, Bandarban.",
    images: [],
  ...
  },
  {
    ...
    prominence: 0,
    range: "Reng Tlang Range",
    description: "Tripura language name meaning 'bad hilly place for vegetation'. 6th or 5th highest peak of Bangladesh. GPS measured at 967 m (3,173 ft) by BD Explorer (Dec 2014, first ascent). Second highest of Reng Tlang range after Dumlong.",
    images: [],
  ...
  },
  {
    ...
    prominence: 0,
    range: "Mowdok Range",
    description: "4th or 5th highest peak of Bangladesh. GPS measured at 983 m (3,222 ft). Located in the remote Modak Range. Yogi Haphong means 'Hermit/Monk Mountain' — a sacred name among tribal communities. Access: Bandarban → Thanchi → Remakri Bazar → Dalyan Para.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    name_en: "Zow Tlang",
    name_bn: "জো ত্লাং",
    alt_name: "Reang Haphong / Modak Mual",
    slug: "zow-tlang",
    altitude_ft: 3320,
    altitude_m: 1012,
    height_source: "gps",
    ...
    prominence: 0,
    range: "Mowdok Range",
    description: "Considered 2nd or 3rd highest peak. GPS measured at 1,022 m (3,353 ft) by multiple 2014 expeditions. Zow refers to 'Mizo' (from Mizoram); Tlang = mountain in Bawm language. Known for the most difficult climbing path among Bangladeshi peaks. Access: Bandarban → Thanchi → Remakri Bazar → Dalyan Para.",
    images: [],
  ...
  },
  {
    ...
    prominence: 343,
    range: "Upper Mowdok",
    description: "Jongriak is the 4th or 5th highest peak of Upper Mowdok range. 'Jongriak' means 'mountain of monkeys' in Bawm language. A tributary called Jongriak Jhiri originates from the peak, containing caves inhabited by monkeys.",
    images: [],
    first_ascent_date: null,
    category: "peak",
    extended: {
      ...
      comments: "4th or 5th highest peak of Upper Mowdok range. Has 3 sub-peaks (min 33 ft prominence). Significant sub-peak at 21°40'03\"N 92°36'17\"E, elevation 3,030 ft, prominence 120–130 ft.",
    },
  },
  {
    id: "75",
  ...
  },
  {
    ...
    prominence: 0,
    range: "Mowdok Range",
    description: "Note: 'Mowdok Mual' is also an alternative name used for Zow Tlang. This is a distinct and separately measured neighboring peak of the Mowdok massif.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  ...
  },
  {
    ...
    prominence: 0,
    range: "Mowdok Range",
    description: "Naga Hung = Serpent/Naga Mountain. The Naga nomenclature may reference the Naga tribal settlements historically in the area.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  ...
  },
  {
    ...
    prominence: 1007,
    range: "Bandarban Hills",
    description: "Busi Taung is located in the Bandarban Hills with 1,007 ft of topographic prominence.",
    images: [],
    first_ascent_date: null,
    category: "peak",
    extended: {
      original_location: "21°29'45.45\"N 92°22'7.60\"E",
      topographic_prominence: "1,007 ft",
      saddle_elevation: "1,109 ft",
      mount_code: "P3c.02",
    },
  },
  {
  ...
  },
  {
    ...
    name_en: "Mowdok Mual",
    name_bn: "মদক মুয়াল",
    alt_name: "Mowdok Third",
    slug: "mowdok-mual-p7b04",
    altitude_ft: 3014,
    altitude_m: 919,
    height_source: "gps",
    region: "Bandarban",
    ...
    difficulty: 7,
    prominence: 401,
    range: "Upper Mowdok / Sakudaung",
    description: "Mowdok Mual is the 6th highest peak of the Mowdok range (with a minimum 300 ft prominence reference; if the reference drops below 300 ft, Tawba Haphong becomes 6th). During the colonial period, Survey of India indicated Zow Tlang as 'Mowdok Mual', and US/Russian military maps followed. But local Tripura and Bawm people distinguish them — they call this peak further south from Zow Tlang as the true Mowdok Mual.",
    images: [],
    first_ascent_date: null,
    category: "peak",
    extended: {
      survey_name: "Mowdok Third",
      survey_name_note: "During the colonial period, Survey of India indicated Zow Tlang as Mowdok Mual. Later US and Russian Military used the same name for Zow Tlang. But according to local Tripura and Bawm people, Zow Tlang and Mowdok Mual are not the same peak. They call a peak further south from Zow Tlang as Mowdok Mual.",
      original_location: "21°38'31\"N 92°36'21\"E",
      political_location: "Remakri Union, Thanchi Upazilla, Bandarban, Bangladesh & Paletwa Township, Matupi District, Chin State, Myanmar",
      geological_location: "Sakudaung syncline, Kaladan Fault, Chittagong-Tripura folded belt",
      google_earth_elevation_ft: 2928,
      google_earth_elevation_note: "1 arc-second X-band SRTM data.",
      earlier_survey_elevation_ft: 2940,
      earlier_survey_elevation_note: "Remote sensing survey data by Survey of India under British Military 1935–36.",
      topographic_prominence: "398–405 ft",
      geographic_isolation: "2.5 km",
      isolation_direction: "North",
      key_col_location: "21°38'42\"N 92°36'22\"E",
      key_col_distance: "348 m, North-East",
      key_col_elevation: "2,610–2,615 ft",
      line_parent: "Zow Tlang",
      line_parent_note: "With a minimum 300 ft prominence reference. If the reference drops below 300 ft, this will change.",
      prominence_parent: "Zow Tlang",
      island_parent_location: "21°40'23\"N 92°36'15\"E",
      nearest_settlement: "Headman Para",
      drainage: "Two streams originate from the north and south ridges of Mowdok Mual, confluencing with Choto Mowdok Chara which originates from the slope of south ridges of Zow Tlang. The downstream finally confluences with Sangu River.",
      comments: "6th highest peak of Mowdok range (min 300 ft prominence ref). Measured elevations: 3,008 ft (GDOP <1.5, 24 satellites), 3,014 ft (Altimeter Offline), 3,021 ft (Altimeter Examobile). US/Russian topo maps show two saddles between Mowdok Mual and Zow Tlang at same elevation, but 30 m DEM data and field measurements confirm the saddle closer to Mowdok Mual is the key col as it drops more.",
      mount_code: "P7b.04",
    },
  },
  {
    ...
    prominence: 771,
    range: "Reng Tlang Range",
    description: "Unnamed peak (code P11.05) in the Reng Tlang Range with 771 ft of topographic prominence. At 3,041 ft, it is a significant summit.",
    images: [],
    first_ascent_date: null,
    category: "peak",
    extended: {
      original_location: "22°5'24.29\"N 92°34'46.33\"E",
      topographic_prominence: "771 ft",
      saddle_elevation: "2,270 ft",
      mount_code: "P11.05",
    },
  },
  {
...
export const waterfalls: Waterfall[] = [
  ...
  },
  {
    ...
    contributor: "Zaqiul Deep",
    coordinates_pending: false,
    nearby_peak_slugs: ["keokradong", "capital", "lakhudong"],
    images: [],
    trail_files: [],
    hydrology: null,
  },
  ...
  },
  {
    ...
    contributor: "",
    coordinates_pending: false,
    nearby_peak_slugs: ["lakhudong", "capital"],
    images: [],
    trail_files: [],
    hydrology: null,
  },
