...
export const mountains: Mountain[] = [
  ...
  },
  {
    ...
    prominence: 0,
    range: "",
    description: "Aiyang Tlang stands at 3,298 ft in Thanchi, Bandarban. Coordinates pending field survey.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    id: "28",
    name_en: "Maithai Jama Haphong",
    name_bn: "মাইথাই জামা হাফং",
    alt_name: "",
    slug: "maithai-jama-haphong",
    altitude_ft: 3174,
    altitude_m: 967,
    height_source: "gps",
    region: "Rangamati",
    ...
    prominence: 0,
    range: "Reng Tlang",
    description: "Maithai Jama Haphong stands at 3,174 ft in Belaichori, Rangamati. Height measured by BD Explorer in 2014.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    id: "29",
    name_en: "Mukhra Thuthai Haphong",
    name_bn: "মুখরা থুথাই হাফং",
    alt_name: "",
    slug: "mukhra-thuthai-haphong",
    altitude_ft: 3129,
    altitude_m: 954,
    height_source: "gps",
    region: "Rangamati",
    ...
    prominence: 0,
    range: "Reng Tlang",
    description: "Mukhra Thuthai Haphong stands at 3,129 ft in Belaichori, Rangamati.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    id: "30",
    name_en: "Haja Chora Haphong",
    name_bn: "হাজা ছড়া হাফং",
    alt_name: "",
    slug: "haja-chora-haphong",
    altitude_ft: 3105,
    altitude_m: 946,
    height_source: "gearth",
    region: "Bandarban",
    ...
    prominence: 0,
    range: "",
    description: "Haja Chora Haphong stands at 3,105 ft in Thanchi, Bandarban. Coordinates pending field survey.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 0,
    range: "Lowmbok Row",
    description: "Kreikung Taung (also Ngaramh Tlang) stands at 3,083 ft in Ruma, Bandarban, in the Lowmbok Row range.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 0,
    range: "",
    description: "Nasai Hum stands at 3,005 ft in Thanchi, Bandarban. Coordinates pending field survey.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1729,
    range: "Naga Hills",
    description: "Thangnang stands at 2,418 ft in Kaptai, Rangamati. Notable for its high prominence of 1,729 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1506,
    range: "Naga Hills",
    description: "Bhati Main stands at 1,827 ft on the border of Rangamati and Khagrachari. Prominence: 1,506 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1430,
    range: "Naga Hills",
    description: "Belachari 2 stands at 1,913 ft in Rangamati Sadar. Prominence: 1,430 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1385,
    range: "Naga Hills",
    description: "Khan Tlang stands at 2,244 ft in Belaichori, Rangamati. Prominence: 1,385 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1296,
    range: "Naga Hills",
    description: "Changpui stands at 2,031 ft in Rangamati Sadar. Prominence: 1,296 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1191,
    range: "Naga Hills",
    description: "Furmon Hill stands at 1,621 ft in Rangamati Sadar. Prominence: 1,191 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1414,
    range: "Naga Hills",
    description: "Ramiu Taung stands at 2,995 ft in Ruma, Bandarban. Prominence: 1,414 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 2293,
    range: "Naga Hills",
    description: "Kris Taung stands at 2,949 ft in Ruma, Bandarban. Notable for its very high prominence of 2,293 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 1775,
    range: "Naga Hills",
    description: "Mowdok Taung stands at 2,933 ft in Naikhongchhari, Bandarban. Prominence: 1,775 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 0,
    range: "Naga Hills",
    description: "Chokki Nala stands at 2,802 ft in Rowangchari, Bandarban.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 348,
    range: "Naga Hills",
    description: "Tajing Daung stands at 2,772 ft in Naikhongchhari, Bandarban. Prominence: 348 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 443,
    range: "Naga Hills",
    description: "Rungrang Taung stands at 2,772 ft in Rowangchari, Bandarban. Prominence: 443 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 541,
    range: "Naga Hills",
    description: "Nilgiri Top stands at 2,297 ft in Rowangchari, Bandarban. Prominence: 541 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 246,
    range: "Naga Hills",
    description: "Lungtian stands at 2,257 ft in Kaptai, Rangamati. Prominence: 246 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
  {
    ...
    prominence: 190,
    range: "Naga Hills",
    description: "Lutiban stands at 1,093 ft in Khagrachari. Prominence: 190 ft.",
    images: [],
    first_ascent_date: null,
    category: "peak",
  },
